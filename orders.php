...
<main>
    <div class="container">
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-12 col-md-7 col-lg-6 col-xxl-8 text-end mb-3">
                <div class="d-inline-block">
                    <!-- Print Button Start -->
                    <button class="btn btn-icon btn-icon-only btn-foreground-alternate shadow" data-bs-toggle="tooltip"
                        data-bs-placement="top" data-bs-delay="0" title="" type="button" data-bs-original-title="Print">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none"
                            stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div class="d-inline-block">
                        <button class="btn p-0" data-bs-toggle="dropdown" type="button" data-bs-offset="0,3">
                            <span class="btn btn-icon btn-icon-only btn-foreground-alternate shadow dropdown"
                                data-bs-delay="0" data-bs-placement="top" data-bs-toggle="tooltip" title=""
                    ...
                    <div class="dropdown-as-select d-inline-block" data-childselector="span">
                        <button class="btn p-0 shadow" type="button" data-bs-toggle="dropdown" aria-haspopup="true"
                            ...
                            <span class="btn btn-foreground-alternate dropdown-toggle" data-bs-toggle="tooltip"
                                ...
                                data-bs-original-title="Item Count">10 Items</span>
                        </button>
                        <div class="dropdown-menu shadow dropdown-menu-end">
                    ...
                    if ($categoryProducts) {
                                ...
                                <div class="row g-0 h-100 sh-lg-9 position-relative">
                                    <a class="col-auto ">
                                        <img src="<?= ($val['productImage']) ? $val['productImage'] : 'uploads/defualt_products.png' ?>"
                                            alt="product" class="card-img card-img-horizontal sw-11" style="height:72px;">
                                    </a>
                                        ...
                                        <div class="ps-5 pe-4 h-100">
                                            <div class="row g-0 h-100 align-content-center">
                                                ...
                                                <div
                                                    ...
                                                    <div class="lh-1 text-alternate"><input
                                                            id="quantatiy_<?php echo $val['id'] ?? '' ?>" type="number"
                                                            value="1" min="1" class="w-20"></div>
                                                </div>
                                                <div
                                                    class="col-12 col-lg-3 d-flex flex-column pe-1 mb-2 mb-lg-0 justify-content-center order-4">
                                                    <div class="lh-1 text-alternate"><input
                                                            id="available_<?php echo $val['id'] ?? '' ?>" type="number"
                                                            value="1" min="1" class="w-20"></div>
                                                </div>
                                                <div
                                                ...
                                                <div
                                                    ...
                                                    <label class="form-check mt-2">
                                                        <input type="checkbox"
                                                            class=" product-checkboxes form-check-input pe-none"
                        ...
                        endforeach; ?>
                            <div class="w-100 d-flex justify-content-center">
                                <input id="orderButton" class="btn btn-primary mb-1" type="submit" onclick="submitOrder()"
                                    value="Order Now">
                            </div>
                    <?php } else { ?>

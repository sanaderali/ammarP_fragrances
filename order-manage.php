          ...
          <div class="card mb-5">
            <div class="row g-0 sh-lg-10 h-auto p-card pt-lg-0 pb-lg-0">
              <div class="col-lg-4 d-flex align-items-center">
                <p class="mb-0 pe-0 pr-lg-4"><b>Shop</b><br>
                  <?= $val['shop_name'] ?? '' ?>
                </p>
              </div>
              ...
              <div class="col-lg-2 d-flex align-items-center mb-3 mb-lg-0">
                <span class="badge bg-tertiary text-uppercase">
                  <?= ($val['status'] == 'Pending') ? 'New' : (($val['status'] == 'Completed') ? 'Completed' : 'Canceled') ?>
                </span>
              </div>
                  ...
                  if ($_SESSION['user_role'] == 'admin' && $val['status'] == 'Pending') {
                    ...
                    <form action="order-manage.php" method="POST">
                      ...
                      <button data-order_id="<?= $val['order_id'] ?? '' ?>"
                        class="btn btn-sm btn-icon btn-icon-only btn-outline-primary" type="submit">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none"
                          stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <form action="order-manage.php" method="POST">
                      ...
                      <button data-order_id="<?= $val['order_id'] ?? '' ?>"
                        class="btn btn-sm btn-icon btn-icon-only btn-outline-secondary ms-1" type="submit">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none"
                          stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"
